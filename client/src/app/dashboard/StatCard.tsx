...
const StatCard = (
  { title, primaryIcon, details, dateRange }: StatCardProps,
) => {
  ...
  return (
    <div className="xl:row-span-2 md:row-span-1 bg-white shadow-md rounded-2xl flex flex-col justify-between">
      {/* HEADER */}
      <div>
                ...
                <div className="flex items-center">
                  <detail.IconComponent
                    className={`w-4 h-4 mr-1 ${
                      getChangeColour(detail.changePercentage)
                    }`}
                  />
