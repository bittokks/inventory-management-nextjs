...
const mockSettings: UserSettings[] = [
  ...
  { label: "E-mail Address", value: "johndoe@mail.com", type: "text" },
...
const Settings = () => {
  ...
  const handleToggleChange = (index: number) => {
    ...
    clone[index].value = !clone[index].value as boolean;
      ...
      <div className="overflow-x-auto mt-5 shadow-md">
        <table className="min-w-full bg-white rounded-lg">
          <thead className="bg-gray-800 text-white">
            <tr>
              <th className="text-left py-3 px-4 uppercase text-sm font-semibold bg-white !text-gray-700">
                Setting
              </th>
              <th className="text-left py-3 px-4 uppercase text-sm font-semibold bg-white !text-gray-700">
                Value
                ...
                <td className="py-2 px-4">
                  {setting.type === "toggle"
                    ...
                    : (
                      <input
                        type="text"
                        className="px-4 py-2 border rounded-lg bg-white !text-gray-600 focus:outline-none focus:border-blue-500"
